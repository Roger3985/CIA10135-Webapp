...
<head>
    ...
    <title>專欄文章回覆刪除 - deleteCR.jsp</title>
</head>
<body bgcolor="white">
...
<%--</li>--%>
    ...
    <form method="post" action="/columnreply/ColumnReplyController" name="deleteForm" onsubmit="return confirm('確定要刪除這條通知嗎？');">
        <b>選擇文章回覆編號:</b>
